...
namespace AggiornaProrogheGeisp
{
    public partial class Main : Form
    {
        ...
        public static List<List<string>> databases = new List<List<string>>();
        ...
        public void initlist() 
        {
            try
            {
                ...
                bs.DataSource= DBnames;
                listBoxDB.DataSource = bs;
                listBoxDB.Refresh();
            }
            catch{}
        }
        ...
        private void buttonExec_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < databases.Count;i++ )
            {
                ...
                {
                    MessageBox.Show("Error!!!" + findError);
        ...
        private string getNota(string stato_agente, string stato_pratica) 
        {
