...
namespace AggiornaProrogheGeisp
{
    ...
    {
        public static string cdir = @"D:\NET_AggiornaProrogheGeisp\program\AggiornaProrogheGeisp\GEISP";
        public static bool running;
        private static List<List<string>> databases;

        public void loadDatabases(XmlDocument doc)
        {
            ...
            {
                doc = new XmlDocument();
                doc.Load(Path.Combine(cdir, "GEISP.xml"));
            }
